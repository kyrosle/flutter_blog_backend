...
/// Git2 example of `git pull`
///
/// accept remote option value and  branch option value which default are `origin` and `master`
///
/// If Success else return git2::Error
///
/// ```
